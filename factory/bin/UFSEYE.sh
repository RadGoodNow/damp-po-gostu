mkdir ./../sdcard/data
log_file="./sdcard/data/UFSEYE_LOG"
result_file="./sdcard/data/UFSEYE_result"
if [ -d "${log_file}" ]; then
	echo "delete file"
	rm  -r ${log_file}
else
...
log_file_path=/sdcard/data/UFSEYE_LOG/${project_info}_${ufs_model}_${fw_version}_${current_date_time}_UFSEYE_log.txt
result_file_path=/sdcard/data/UFSEYE_result/UFSEYE_result.txt
...
echo "device_eye_lane0_width: \"${device_lane0_eom_max_width}\"" | tee -a $result_file_path 
echo "device_eye_lane0_height: \"${device_lane0_eom_max_height}\"" | tee -a $result_file_path  
echo "device_eye_lane1_width: \"${device_lane1_eom_max_width}\"" | tee -a $result_file_path  
echo "device_eye_lane1_height: \"${device_lane1_eom_max_height}\"" | tee -a $result_file_path  
echo "host_eye_lane0_width: \"${host_lane0_eom_max_width}\"" | tee -a $result_file_path  
echo "host_eye_lane0_height: \"${host_lane0_eom_max_height}\"" | tee -a $result_file_path  
echo "host_eye_lane1_width: \"${host_lane1_eom_max_width}\"" | tee -a $result_file_path  
echo "host_eye_lane1_height: \"${host_lane1_eom_max_height}\"" | tee -a $result_file_path  
